...
public class ArticlesControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_articles() throws Exception {
                ...
                Articles article2 = Articles.builder()
                                .title("sadarticle")
                                .url("otherrandomurl.com")
                                .explanation("A sad article.")
                                .email("otherrandomname@gmail.com")
                                .dateAdded(ldt2)
                                .build();
        ...
        public void an_admin_user_can_post_a_new_article() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=funarticle&url=randomurl.com&explanation=Funarticlehere&email=randomname@gmail.com&dateAdded=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
